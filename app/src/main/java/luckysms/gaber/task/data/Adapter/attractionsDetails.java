...
public class attractionsDetails extends RecyclerView.Adapter<attractionsDetails.MyViewHolder> {
    private Context context;
    private List<Attraction> list = new ArrayList<>();

    public attractionsDetails(Context context, List<Attraction> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public attractionsDetails.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_item, parent, false);
        attractionsDetails.MyViewHolder myViewHolder = new attractionsDetails.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(attractionsDetails.MyViewHolder holder, int position) {
        Attraction data=list.get(position);
